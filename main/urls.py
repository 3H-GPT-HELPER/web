...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='main/login.html'), name='main_login'),
    #path('loginIndex/', auth_views.LoginView.as_view(template_name='main/loginIndex.html'), name='loginIndex'),
